...
namespace Api.Service.Services
{
    public class CepService : ICepService
    {
        ...
        public async Task<CepCreateResultDto> Post(CepCreateDto cepCreateDto)
        {
            var model = _mapper.Map<CepModel>(cepCreateDto);
        ...
        public async Task<CepUpdateResultDto> Put(CepUpdateDto cepUpdateDto)
        {
            var model = _mapper.Map<CepModel>(cepUpdateDto);
            var entity = _mapper.Map<CepEntity>(model);
